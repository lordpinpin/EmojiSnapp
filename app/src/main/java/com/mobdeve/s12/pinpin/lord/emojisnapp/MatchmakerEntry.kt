...
data class MatchmakerEntry(val user: String? = null, var opp: String? = null, var emojiMessage: Message = Message(), val retreat: Boolean? = null, var isOver: Boolean? = false)
